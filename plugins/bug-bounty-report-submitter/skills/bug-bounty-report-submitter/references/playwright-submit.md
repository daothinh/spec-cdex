...
6. Build `submission.json` from `form-schema.json`. Draft the report only after the schema is known.
...
12. Take a final `browser_snapshot` and verify the visible content matches `submission.json`.
