...
5. Draft the detail body from the shared Immunefi-style skeleton before adapting it to the live form or mailbox, so the final report always shows the exact bug location, root cause, exploit path, PoC output, and minimal exploit excerpt.
