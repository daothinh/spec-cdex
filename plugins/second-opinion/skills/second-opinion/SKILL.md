...
- Falls back to `gpt-5.2-codex` on auth errors; keep this legacy fallback pinned unless explicitly migrated
...
| Model auth error (Codex) | Retry with `gpt-5.2-codex` legacy fallback |
